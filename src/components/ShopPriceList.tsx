...
type ShopLinksVariant = "list" | "buttons";
...
interface ProductShopLinksProps {
  ...
  maxItems?: number;
  size?: ShopLinksSize;
  /** list = kaarten/tabel; buttons = bestel-knoppen (productpagina) */
...
/** Winkellinks — lijst op overzichtspagina's, knoppen op productpagina. */
          ...
          return (
            <li key={offer.retailer}>
              <AffiliateButton
                ...
                retailer={isCheapest ? `${label} ✓` : label}
                price={offer.price}
