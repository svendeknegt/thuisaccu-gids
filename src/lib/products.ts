...
export const products: Product[] = [
  ...
  },
  {
    ...
    capacity: 0.512,
    power: 500,
    price: ECOFLOW_URLS.river2Max.price,
    rating: 4.5,
    image: ECOFLOW_URLS.river2Max.image,
    retailer: "ecoflow",
    shopUrl: ECOFLOW_URLS.river2Max.url,
    pros: [
      "512 Wh LFP — vol in ~60 min",
      "Licht (6,1 kg) met 2×230V",
      "X-Boost tot 1000 W piek",
    ],
    cons: ["500 W continu", "Te klein als enige thuisaccu"],
    bestFor: "budget",
    capacityCategory: "small",
    type: "Plug & Play",
    chemistry: "LFP (LiFePO4)",
    ...
    weight: "6,1 kg",
    description:
      "Middenklasse RIVER-serie: 512 Wh, snel opladen en app-bediening — ideaal voor camping en lichte back-up.",
    suitableFor: [
      "Camping en weekend weg",
      "Lichte noodstroom voor modem en verlichting",
      "Wie EcoFlow NL en Amazon wil vergelijken",
    ],
    buyingGuide:
      "De RIVER 2 Max (512 Wh / 500 W) zit tussen RIVER 2 Pro en compacte instappers. EcoFlow NL is vaak goedkoper dan Amazon.nl — vergelijk via onze winkelknoppen vóór je bestelt.",
    amazonOffer: {
      shopUrl: AMAZON_URLS.ecoflowRiver2Max.url,
      price: AMAZON_URLS.ecoflowRiver2Max.price,
      image: AMAZON_URLS.ecoflowRiver2Max.image,
      asin: AMAZON_URLS.ecoflowRiver2Max.asin,
    },
  },
  {
    ...
    capacity: 0.512,
    power: 500,
    price: AMAZON_URLS.jackeryExplorer500V2.price,
    rating: AMAZON_URLS.jackeryExplorer500V2.rating,
    image: AMAZON_URLS.jackeryExplorer500V2.image,
    retailer: "amazon",
    shopUrl: AMAZON_URLS.jackeryExplorer500V2.url,
    pros: [
      "512 Wh LFP — 30% lichter dan v1",
      "UPS-schakeling <10 ms",
      "6000+ laadcycli volgens fabrikant",
    ],
    cons: ["500 W continu", "Geen zware keukenapparaten"],
    bestFor: "budget",
    capacityCategory: "small",
    type: "Plug & Play",
    chemistry: "LFP (LiFePO4)",
    cycles: "6000+",
    warranty: "5 jaar",
    weight: AMAZON_URLS.jackeryExplorer500V2.weight,
    description:
      "Nieuwe Jackery 500-serie met sneller opladen en UPS-functie — compact alternatief voor EcoFlow RIVER 2 Max.",
    suitableFor: [
      "Camping en camper",
      "Noodstroom voor router en verlichting",
      "Kopers die Amazon.nl en Bol.com willen vergelijken",
    ],
    buyingGuide:
      "De Explorer 500 V2 (ASIN B0FL2J6Y8M) concurreert direct met de EcoFlow RIVER 2 Max. Controleer op Bol.com of Amazon.nl welke EU-uitvoering en kabels je ontvangt.",
    extraOffers: [
      {
        retailer: "bol",
        shopUrl: BOL_URLS.jackeryExplorer500V2.url,
        price: BOL_URLS.jackeryExplorer500V2.price,
        variantNote: "Bol.com — Jackery Explorer 500 V2",
      },
    ],
  },
  {
    id: "anker-solix-f1500",
    name: "Anker Solix F1500",
    brand: "Anker",
    capacity: 1.536,
    power: 1800,
    price: BOL_URLS.ankerSolixF1500.price,
    rating: 4.5,
    image: BOL_URLS.ankerSolixF1500.image,
    retailer: "bol",
    shopUrl: BOL_URLS.ankerSolixF1500.url,
    pros: [
      "1536 Wh middenklasse accu",
      "1800 W continu (2400 W piek)",
      "Anker-app + 5 jaar garantie",
    ],
    cons: ["Zwaarder dan 1 kWh-modellen", "Geen modulaire uitbreiding"],
    bestFor: "budget",
    capacityCategory: "small",
    type: "Plug & Play",
    chemistry: "LFP (LiFePO4)",
    cycles: "3000+",
    warranty: "5 jaar",
    weight: AMAZON_URLS.ankerSolixF1500.weight,
    description:
      "Anker middenklasse powerstation met 1,5 kWh — geschikt als eerste thuisbuffer of serieuze camping-accu.",
    suitableFor: [
      "Huishoudens die ~1,5 kWh zoeken",
      "Back-up voor koelkast, modem en verlichting",
      "Anker-fans via Bol.com of Amazon.nl",
    ],
    buyingGuide:
      "De F1500 (1536 Wh / 1800 W) zit tussen Anker C1000 en F3800 in. Vergelijk Bol- en Amazon-prijs; let op gewicht (~17,5 kg) als je hem regelmatig verplaatst.",
    amazonOffer: {
      shopUrl: AMAZON_URLS.ankerSolixF1500.url,
      price: AMAZON_URLS.ankerSolixF1500.price,
      image: AMAZON_URLS.ankerSolixF1500.image,
      asin: AMAZON_URLS.ankerSolixF1500.asin,
    },
  },
];
