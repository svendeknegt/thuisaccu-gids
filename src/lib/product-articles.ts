...
const productArticleMap: Record<string, string[]> = {
  ...
  "ecoflow-delta-3-classic": ["thuisaccu-kopen", "kwh-berekenen"],
  "ecoflow-delta-3": ["thuisaccu-kopen", "dynamisch", "kwh-berekenen"],
  "ecoflow-river-3-plus": ["thuisaccu-kopen", "kwh-berekenen"],
